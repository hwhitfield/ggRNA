...
#' Get n hex colours
#'
#' @param n Integer indicating number of colours to return
#' @param lum Integer indicating luminance between 0 and 100
#' @param chrom Integer indicating chroma of colour
#'
...
#' getShapes
#'
#' Returns shape palette for names in vec
#'
#' @param vec A character vector of names
#'
...
#' ColourBar
#'
#' Plot custom colour bar to use as a customisable legend for continuous plots
#'
...
#' ShowColPal
#'
#' Plot input colour palette as ggplot object, uses geom_bar
#'
...
#' @examples
#'
#' ## Show what a palette looks like
#' ShowColPal(hcl.colors(100, palette = "Mako"))
#'
#' ## Plot palette options for n=4
#' lapply(GetColPal_options(4), ShowColPal)
#'
#' ## Pick between sequential colour palettes
...
#' GetColPal
#'
#' Returns a named colour palette for the input character vector using the first option in GetColPal_options().
#' The purpose of this function is to obtain quick or default colour palettes that are prettier than ggplot defaults
#'
...
#' GetColPal_options
#'
#' Returns colour palette options of a given length, n.
#'
#' This function has curated palettes from a variety of other colour packages such as wesanderson, Manu, and ggsci
#'
...
GetColPal_options <- function(n){
  ...
  ColPals$`7` <- list(c("#6C803A", "#7B5C34", "#AB7C47", "#CCAE42", "#D73202",  "#272318", "#D3CDBF"),
                   c("#9e5476", "#d18b79",  "#70a18f",
                     ...
                     "#8bbde6", "#6074ab",
                     "grey"))
  ColPals$`9` <- list(c("#59C7EB", "#E0607E", "#0A9086", "#FEA090", "#3E5496", "#EFDC60",
...
#' GetViridisCol
#'
#' Helper function to retrieve end colours of viridis cmap as hex values
#'
